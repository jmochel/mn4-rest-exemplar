...
public class ArchitectureTest
{
    ...
    private final DescribedPredicate<JavaClass> areInfrastructure = resideInAnyPackage("org.saltations.mre.infra..");

    private final DescribedPredicate<JavaClass> areSharedCore = resideInAnyPackage("org.saltations.mre.shared.core..");
    private final DescribedPredicate<JavaClass> areSharedDomain = resideInAnyPackage("org.saltations.mre.shared.domain..");
    private final DescribedPredicate<JavaClass> areSharedApp = resideInAnyPackage("org.saltations.mre.shared.app..");
    private final DescribedPredicate<JavaClass> areSharedInfra = resideInAnyPackage("org.saltations.mre.shared.infra..");

    private final DescribedPredicate<JavaClass> areApp  = resideInAnyPackage("org.saltations.mre.app..");
    private final DescribedPredicate<JavaClass> areAppServices = resideInAnyPackage("org.saltations.mre.appservice..");
    ...
    void core_should_not_depend_on_scaffolding() {
        noClasses()
                .that(areCore)
                .should()
                .dependOnClassesThat(areInfrastructure.or(areApp).or(areSharedCore).or(areSharedDomain).or(areSharedApp).or(areSharedInfra))
                .check(classes);
    }
