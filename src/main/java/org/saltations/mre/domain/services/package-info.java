/**
 * Scaffolding packages deal the classes and functionality here deals with the following concepts
 * <dl>
 *   <dt>Core Object</dt>
 ...
 *   See {@link org.saltations.mre.domain.model.Entity} interface</dd>
 *   <dt>Entity Mapper</dt>
 *   <dd>Service providing the functionality to map between <em>core objects</em> and corresponding <em>entities</em>
 *   meta data needed to identify and track this particular object (At the very least a single unique ID).
 *   See {@link org.saltations.mre.domain.model.EntityMapper} interface</dd>
 ...
 *   See base class {@link org.saltations.mre.domain.services.repo.EntityRepoBase}</dd>
 ...
 *   See base class {@link org.saltations.mre.domain.services.service.EntityServiceBase}</dd>
 ...
 *   Creation is done from a provided <em>core object</em>. Patching is done from a provided
 *  <a href="https://datatracker.ietf.org/doc/html/rfc7386">JSON Merge Patch</a>.
 *   See base class {@link org.saltations.mre.domain.services.controller.EntityControllerBase}</dd>
 * </dl>
 */
package org.saltations.mre.domain.services;
