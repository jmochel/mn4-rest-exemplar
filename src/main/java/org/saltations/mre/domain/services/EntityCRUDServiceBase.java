...
public abstract class EntityCRUDServiceBase<ID, IC, C extends IC, E extends Entity<ID>,
                                                ...
                                                EM extends EntityMapper<C,E>>
{
    ...
    public EntityCRUDServiceBase(Class<E> entityClass, ER entityRepo, EntityMapper<C,E> entityMapper, Validator validator)
    {
